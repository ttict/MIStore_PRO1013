<?php 
  ...
  $pageURL = getURL();
  $id = $_GET['id'];
  $slider_query = "select * from $table_sliders where id=$id";
  // var_dump($slider_query);die;
  $data_slider = executeQuery($slider_query);
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
                ...
                <form class="form-horizontal" action="save_update.php" method="post" enctype="multipart/form-data">
                  <input type="hidden" name="id" value="<?=$data_slider['id']?>">
                  <div class="form-group">
                    <label for="inputtitle" class="col-sm-2 control-label">Tiêu đề</label>

                    <div class="col-sm-10">
                      <input name="title" type="text" class="form-control" id="inputtitle" placeholder="Tiêu đề" value="<?=$data_slider['title']?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input name="url" type="text" class="form-control" id="inputurl" placeholder="url" value="<?=$data_slider['url']?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input name="short_desc" type="text" class="form-control" id="inputshort_desc" placeholder="Địa chỉ" value="<?=$data_slider['short_desc']?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group"> 
                    ...
                    <div class="col-sm-10">
                      <div class="div-logo">
                        <img src="<?=$data_slider['image_url']?>" alt="" class="img-logo" id="logo">
