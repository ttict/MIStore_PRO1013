                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="registered-customers">
                                ...
                                <form action="<?= BASE_URL . 'login/post-input-token.php'?>" method="post">
                                    <div class="login-account p-30 box-shadow">
                                        <p>Nhập mã đặt lại mật khẩu gửi tới email</p>
                                        <input type="text" name="token" placeholder="Mã đặt lại">
