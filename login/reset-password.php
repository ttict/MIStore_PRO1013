...
$userQuery = "select * from users where password_reset_token = '$token'";
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="registered-customers">
                                ...
                                <form action="<?= BASE_URL . 'login/post-reset-password.php'?>" method="post">
                                    <div class="login-account p-30 box-shadow">
                                        <p>Nhập mật khẩu mới</p>
                                        <input type="password" name="password" placeholder="Mật khẩu mới">
                                        <input type="hidden" name="id" value="<?= $id ?>">
                                        
                                        <button class="submit-btn-1 btn-hover-1" type="submit">Hoàn tất</button>
                                    </div>
                                </form>
                            </div>
                        </div>
